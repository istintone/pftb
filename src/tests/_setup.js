...
function setup(opts = {}) {
  ...
  code += `\nmodule.exports={getS:()=>S,setS:v=>{S=v;},setM:v=>{_M=v;},newGame,loadGame,save,flushSave,hasSave,deleteSave,`
        ...
        + `mulberry32,calcOvr,makeCard,makeRoster,openScout,coverOf,SIGNATURES,signatureCards,STAT_KEYS,STAT_W,STAT_MAX,OVR_MAX,SUBPOS,ORIGINS,COUNTERS,FINISHES,SET_FINISH,SKILLS,SKILL_FX,SK_GRP,skillsOf,eff,skW,skS,pickOriginCh,pickCounterCh,pickFinish,resolveShot,subGroup,slotFit,fitTier,squadPowerAt,primarySub,pickHand,pickComp,trainRec,trainExp,trainUp,trainStar,trainUps,trainAdd,TRAININGS,trainById,compsAvailable,CUPS,cupById,cupRoundName,cupRound,cupFixtureOf,cupSide,playCupDay,cupEnterable,cupOpen,enterCup,cupNodes,cupLastNode,cupMustPlay,cupNodeNow,cupPlaceName,closeCup,advanceNode,cupDraw,cupPairs,cupMyPair,cupEntrants,cupResolveRound,cupTeamName,cupChampSlot,ORDERS,orderById,setTeamOrder,HANDS,tenureLeft,judgeTenure,checkTenureClosing${extra}};`;
