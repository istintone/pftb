...
function setup(opts = {}) {
  ...
  code += `\nmodule.exports={getS:()=>S,setS:v=>{S=v;},setM:v=>{_M=v;},newGame,loadGame,save,flushSave,hasSave,deleteSave,`
        ...
        + `judgeSeason,myFixture,squadCards,autoSquad,availableCards,sellPrice,sellWhy,buyPrice,buyWhy,buyCard,isLoaned,canSell,sellCard,sellCards,sellTotal,marketList,marketOf,marketPrice,marketWhy,marketBuy,marketSeed,cardById,squadPower,resolveMatch,simulateMatch,matchStats,matchRatings,matchRating,manOfTheMatch,minutesOf,playerOf,spKicker,pickCaptain,staminaOf,createMatch,stepMatch,finishMatch,orderMatch,matchOver,matchMin,matchClock,bestXI,bestFormFor,formFor,matchSide,teamStrength,midPower,`
        + `mulberry32,hashStr,calcOvr,ovrOf,upOf,makeCard,statsFor,applyBody,rollBody,bodyLabel,makeRoster,openScout,coverOf,heightOf,clubAbbr,embRomaji,SIGNATURES,signatureCards,STAT_KEYS,STAT_W,STAT_MAX,OVR_MAX,SUBPOS,ORIGINS,COUNTERS,FINISHES,SET_FINISH,SKILLS,SKILL_FX,SK_GRP,SKILLS_SIG,sigSkillOf,SK_WHEN,SK_WHEN_SHARE,SK_WHEN_WHAT,skOn,skFired,eff,staminaOf,isKp,kpK,kpOf,kpCarry,cpuKp,skMove,skillsOf,eff,skW,skS,skK,SK_SOLO,SK_WHAT,ironK,freshK,momGain,SKILLS,SKILLS_ANY,skillPool,SET_FINISH,pickOriginCh,pickCounterCh,pickFinish,resolveShot,onTarget,offBallHelp,offBall,subGroup,slotFit,fitTier,squadPowerAt,primarySub,pickHand,pickComp,trainRec,trainExp,trainUp,trainStar,trainUps,starUp,liveOvr,liveCard,myPower,trainAdd,trainReady,trainAwake,bondKey,bondOf,bondK,bondBuilt,bondSum,bondAdd,bondMatch,bondIsGold,bondCanAwake,bondAwake,bondReadyWith,BOND_AWAKES,bondPairs,bondTier,mailTick,mailPush,mailTrim,mailDef,sponMail,seenHas,seeNow,seenAll,TUT_ALL,mailList,mailLatest,mailUnread,mailRead,mailTake,mailHas,mailSent,mailWasSent,SEC_NAMES,secretaryName,migrate,SAVE_VER,MAILS,mailById,TICKETS,ticketById,ticketCount,ticketAdd,ticketUse,ticketTotal,drawLegend,drawSig,MEMORABILIA,memById,memHas,memList,memUnlock,memSide,memReward,memAward,memOwned,sponsor,sponOffers,sponSign,sponHit,sponPay,sponTick,sponPending,sponGoalText,sponPrizeText,sponCoin,sponAid,sponAidById,sponsorById,sponPrize,SPONSORS,SPONSOR_AID,SPON_PRIZE,streakAdd,handsNow,handNow,fameLose,trustOf,trustAdd,trustMatch,trustHand,trustNews,mentorPending,luckPick,tradePending,tradeDo,tradeHint,tradeOuts,luckApply,LUCK_ROLES,mentorAnswer,isMentor,mentorFull,makeLegacy,applyLegacy,makeStay,stayClub,MENTORS,condOf,condSet,condMul,condMove,condAfterMatch,condCpu,condHurt,condInjure,hurtList,hurtTick,applyInjuries,restAll,COND_MAX,COND_MIN,COND_HURT,TRAININGS,trainById,AWAKES,compsAvailable,CUPS,cupById,cupRoundName,cupRound,cupFixtureOf,cupSide,playCupDay,cupEnterable,cupEnterables,cupOpen,enterCup,cupNodes,cupLastNode,cupMustPlay,cupNodeNow,cupPlaceName,closeCup,advanceNode,cupDraw,cupPairs,cupMyPair,cupEntrants,cupResolveRound,cupTeamName,cupChampSlot,trophyDefs,trophyAdd,trophyOf,trophyCount,lgTrophyId,ORDERS,orderById,TACTICS,tacticById,clubTactic,learnRoll,tacticWhy,tacticOk,learnTactic,tacticNote,tacticsKnown,setTeamTactic,setTeamOrder,HANDS,tenureLeft,judgeTenure,checkTenureClosing,FACILITIES,facById,facStart,facLv,facCanBuild,facBuild,facTick,gateIncome,facTrainGain,facMedK,facMedHeal,facScoutK,youthNode,youthPending,youthMake,youthAward,youthRarity,isYouth,youthUps,evalAdd,evalMatch,ownerTenure,expectedRank,cpuSquad,coachName,coachType,COACHES,coachById,foeBrief${extra}};`;
