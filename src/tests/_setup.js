...
function setup(opts = {}) {
  ...
  code += `\nmodule.exports={getS:()=>S,setS:v=>{S=v;},setM:v=>{_M=v;},newGame,loadGame,save,flushSave,hasSave,deleteSave,`
        ...
        + `mulberry32,hashStr,calcOvr,makeCard,statsFor,applyBody,rollBody,bodyLabel,makeRoster,openScout,coverOf,SIGNATURES,signatureCards,STAT_KEYS,STAT_W,STAT_MAX,OVR_MAX,SUBPOS,ORIGINS,COUNTERS,FINISHES,SET_FINISH,SKILLS,SKILL_FX,SK_GRP,SKILLS_SIG,sigSkillOf,SK_WHEN,SK_WHEN_SHARE,SK_WHEN_WHAT,skOn,skFired,skMove,skillsOf,eff,skW,skS,skK,SK_SOLO,SK_WHAT,ironK,freshK,momGain,SKILLS,SKILLS_ANY,skillPool,SET_FINISH,pickOriginCh,pickCounterCh,pickFinish,resolveShot,subGroup,slotFit,fitTier,squadPowerAt,primarySub,pickHand,pickComp,trainRec,trainExp,trainUp,trainStar,trainUps,trainAdd,trainReady,trainAwake,bondKey,bondOf,bondSum,bondAdd,bondMatch,bondIsGold,bondCanAwake,bondAwake,bondReadyWith,BOND_AWAKES,bondPairs,bondTier,mailTick,mailList,mailLatest,mailUnread,mailRead,mailTake,mailHas,MAILS,mailById,TICKETS,ticketById,ticketCount,ticketAdd,ticketUse,ticketTotal,drawLegend,sponsor,sponOffers,sponSign,sponHit,sponPay,sponTick,sponPending,sponGoalText,sponPrizeText,sponCoin,sponAid,sponAidById,sponsorById,sponPrize,SPONSORS,SPONSOR_AID,SPON_PRIZE,streakAdd,handsNow,handNow,fameLose,trustOf,trustAdd,trustMatch,trustHand,trustNews,mentorPending,mentorAnswer,isMentor,mentorFull,makeLegacy,applyLegacy,MENTORS,condOf,condSet,condMul,condMove,condAfterMatch,condCpu,condHurt,condInjure,hurtList,hurtTick,applyInjuries,restAll,COND_MAX,COND_MIN,COND_HURT,TRAININGS,trainById,AWAKES,compsAvailable,CUPS,cupById,cupRoundName,cupRound,cupFixtureOf,cupSide,playCupDay,cupEnterable,cupEnterables,cupOpen,enterCup,cupNodes,cupLastNode,cupMustPlay,cupNodeNow,cupPlaceName,closeCup,advanceNode,cupDraw,cupPairs,cupMyPair,cupEntrants,cupResolveRound,cupTeamName,cupChampSlot,trophyDefs,trophyAdd,trophyOf,trophyCount,lgTrophyId,ORDERS,orderById,setTeamOrder,HANDS,tenureLeft,judgeTenure,checkTenureClosing,FACILITIES,facById,facStart,facLv,facCanBuild,facBuild,facTick,gateIncome,facTrainGain,facMedK,facMedHeal,facScoutK,evalAdd,evalMatch,ownerTenure,expectedRank,cpuSquad,coachName,foeBrief${extra}};`;
