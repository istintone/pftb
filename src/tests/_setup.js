...
function setup(opts = {}) {
  ...
  code += `\nmodule.exports={getS:()=>S,setS:v=>{S=v;},setM:v=>{_M=v;},newGame,loadGame,save,flushSave,hasSave,deleteSave,`
        ...
        + `mulberry32,hashStr,calcOvr,makeCard,makeRoster,openScout,coverOf,SIGNATURES,signatureCards,STAT_KEYS,STAT_W,STAT_MAX,OVR_MAX,SUBPOS,ORIGINS,COUNTERS,FINISHES,SET_FINISH,SKILLS,SKILL_FX,SK_GRP,skillsOf,eff,skW,skS,skK,SK_SOLO,SK_WHAT,ironK,freshK,momGain,SKILLS,SKILLS_ANY,skillPool,SET_FINISH,pickOriginCh,pickCounterCh,pickFinish,resolveShot,subGroup,slotFit,fitTier,squadPowerAt,primarySub,pickHand,pickComp,trainRec,trainExp,trainUp,trainStar,trainUps,trainAdd,trainReady,trainAwake,bondKey,bondOf,bondSum,bondAdd,bondMatch,bondIsGold,bondCanAwake,bondAwake,bondReadyWith,BOND_AWAKES,bondPairs,bondTier,condOf,condSet,condMul,condMove,condAfterMatch,condCpu,condHurt,condInjure,hurtList,hurtTick,applyInjuries,restAll,COND_MAX,COND_MIN,COND_HURT,TRAININGS,trainById,AWAKES,compsAvailable,CUPS,cupById,cupRoundName,cupRound,cupFixtureOf,cupSide,playCupDay,cupEnterable,cupOpen,enterCup,cupNodes,cupLastNode,cupMustPlay,cupNodeNow,cupPlaceName,closeCup,advanceNode,cupDraw,cupPairs,cupMyPair,cupEntrants,cupResolveRound,cupTeamName,cupChampSlot,ORDERS,orderById,setTeamOrder,HANDS,tenureLeft,judgeTenure,checkTenureClosing,evalAdd,evalMatch,ownerTenure,expectedRank,cpuSquad,coachName,foeBrief${extra}};`;
