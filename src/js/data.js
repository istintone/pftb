...
const HELP={
  ...
  chat:()=>"クラブのグループチャットです。ここで1節の準備をすべて決めます。"
    ...
    +"<b>訓練</b>は成功+"+TUNING.trust.trainOk+"・大成功+"+TUNING.trust.trainGreat
    +"・失敗"+TUNING.trust.trainFail+"、"
    +"<b>交流</b>は成功+"+TUNING.trust.bondOk+"・大成功+"+TUNING.trust.bondGreat
    +"・失敗"+TUNING.trust.bondFail+"です（交流は2人とも動きます）。"
