...
const HELP={
  ...
  deck:()=>{
    ...
    return "ピッチの11枠に選手を並べます。"
      ...
      +"<br>立ち絵の左下の印は<b>その日の調子</b>です。"
      +"<b>▲</b>が緑→橙→赤の順に良く、<b>▽</b>は不調、<b>✚</b>は治療中。"
      +"休息（打ち手）で1段よくなります。"
      +"<br><b>白い線</b>は選手同士の<b>連携</b>で、太いほど噛み合っています。"
      +"試合と交流で積み上がり、<b>編成から外しても消えません</b>（戻せば続きから）。"
      +"消えるのは任期が明けたときだけです。"
      +"<br>十分に噛み合った組は<b>交流で覚醒</b>することがあり、"
...
const HANDS=[
  ...
  { id:"bond",  icon:"🤝", label:"交流", desc:"選手同士の連携が上がる（噛み合えば覚醒も）", done:"交流" },
...
const TUNING={
  ...
  bond:{ match:{ base:1, nation:1, club:1 }, great:5, ok:3, fail:0,
         t1:40, t2:80, t3:120, t4:160,
         k1:1.03, k2:1.06, k3:1.10, k4:1.16 },
