...
const HELP={
  ...
  board:"シーズンの総括です。上位2クラブは昇格、下位2クラブは降格し、"
    +"次のシーズンは同じクラブのまま新しい部で戦います。"
    +"オーナーの評価が下限を割ると任期が削られます(解任はありません)。",
  ...
  standings:"リーグの順位表です。"
    +"<br>会長の期待順位を下回り続けると評価が下がり、任期が削られます。"
...
const CUPS=[
  { id:"kings", name:"キングズクラブカップ", every:7, needExp:1000, rounds:3,
    prize:[3000,1200,600,300], bias:2, elite:0.04, trophy:"キングズクラブカップ 優勝",
  ...
  { id:"conti", name:"大陸チャンピオンズカップ", every:10, needExp:2500, needDiv:1, rounds:3,
    prize:[9000,3600,1800,900], bias:9, elite:0.22, trophy:"大陸チャンピオンズカップ 優勝",
...
/**
 * シーズン総括でのオーナーの言葉(→docs/03 §3.24)。
 * **評価そのものより、次に何を期待されているか**を伝える。改行は入れない(→§3.22の教訓)。
 *   up=昇格 / over=期待超え / met=期待どおり / under=期待割れ / down=降格
 */
const OWNER={
...
const CHAT={
  open:["監督、おはようございます。第{d}節の準備を始めましょう。",
        "監督、お待ちしていました。第{d}節の段取りを確認します。",
        "監督、今日もよろしくお願いします。第{d}節の準備です。"],
  cupAsk:"本日は {c} の開催日です。エントリーの手続きを取りますか？",
  cupYes:"承知しました。エントリーを済ませました。初戦の相手は {f} です。",
  cupNo:"かしこまりました。今節はリーグ戦に集中しましょう。",
  cupStay:"{c} を勝ち残っています。今節は {r}、相手は {f} です。",
  foeLeague:"今節のリーグ戦は {f} 戦、{v} です。",
  handAsk:"チームに何をさせましょうか。",
  whoAsk:"誰を呼びますか。",
  restSec:"全員に休養を伝えました。",
  restDone:"{g}人の調子が上向いています。",
  restHeal:"{g}人の調子が上向き、うち{h}人はピッチに戻れます。",
  restNone:"みな仕上がっていますね。今日はゆっくり休ませましょう。",
  restUrge:"監督、{n} がまだ治療中です。休ませてやると早く戻ってきますよ。",
  callTrain:["監督、お呼びですか。何をやりましょう。","はい監督。今日は何をしますか。",
             "呼ばれて来ました。メニューをください。"],
  callBond:["監督、誰と話せばいいですか。","はい。相手を指名してください。",
            "了解です。誰と組みましょう。"],
  bondAsk:"{m} と何をすればいいですか。",
  ...
  // 積み上がりはカード詳細で見られるので、ここでは気持ちだけ添える
  ...
  awakeKeep:["ざんねんでした。次に期待しましょう。","惜しかったですね。またの機会に。",
             "あと少しでしたね。焦らずいきましょう。"],
  eventNone:"今節、特別な予定は入っていません。",
  ready:["すべての準備が整いました。試合へ向かいましょう。","準備完了です。ピッチでお待ちしています。",
         "以上です。あとは戦うだけですね。"],
};
